...
def test_get_exposure():
    fimserve.getpopulation_exposure(
        ...
        pop_raster=None,  # If None, it will fetch the population raster from S3 and clip it using the provided boundary. YES- user defined gridded population raster
        # Original source - https://data.humdata.org/dataset/united-states-high-resolution-population-density-maps-demographic-estimates
    )
